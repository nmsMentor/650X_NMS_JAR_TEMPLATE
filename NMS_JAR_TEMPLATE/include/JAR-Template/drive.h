...
public: 
  ...
  //void control_arcade(); <-- original !! DO NOT MOD !!
  void control_arcade_leftJoy();    // MOD
  void control_arcade_rightJoy();   // MOD
  void control_arcade_splitLeft();  // MOD
  void control_arcade_splitRight(); // MOD
