...
//*****************************************************************************************\
// JAR Template MOD Drive Options
// 
...
/**
 * Arcade Drive: Left Joystick Control Full
 * In JAR Template MOD Arcade Drive Left Joystick Control Full,
 * the left joystick controls forward/backward movement on Axis 3, 
 * and also the left joystick controls turning on Axis 4.
 *
 **/
void Drive::control_arcade_leftJoy()
{
  // throttle fwd|rev Axis3 + Axis4
  float throttle = deadband(controller(primary).Axis3.value()+controller(primary).Axis4.value(), 5);
  // turn left|right Axis3 - Axis4
  float turn = deadband(controller(primary).Axis3.value()-controller(primary).Axis4.value(), 5);
  DriveL.spin(fwd, to_volt(throttle+turn), volt);
  DriveR.spin(fwd, to_volt(throttle-turn), volt);
}

/**
 * Arcade Drive: Right Joystick Control Full
 * In JAR Template MOD Arcade Drive Right Joystick Control Full,
 * the right joystick controls forward/backward movement on Axis 2, 
 * and also the right joystick controls turning on Axis 1.
 *
 **/
void Drive::control_arcade_rightJoy()
{
  // throttle fwd|rev Axis2 + Axis1
  float throttle = deadband(controller(primary).Axis2.value()+controller(primary).Axis1.value(), 5);
  // turn left|right Axis2 - Axis1
  float turn = deadband(controller(primary).Axis2.value()-controller(primary).Axis1.value(), 5);
  DriveL.spin(fwd, to_volt(throttle+turn), volt);
  DriveR.spin(fwd, to_volt(throttle-turn), volt);
}

/**
 * Arcade Drive: Split Left 
 * In JAR Template MOD arcade drive split left, 
 * the left joystick controls forward/backward movement, 
 * and the right joystick controls turning.
 *
 **/
void Drive::control_arcade_splitLeft()
{
  float throttle = deadband(controller(primary).Axis3.value(), 5);
  float turn = deadband(controller(primary).Axis1.value(), 5);
  DriveL.spin(fwd, to_volt(throttle+turn), volt);
...
/**
 * Arcade Drive: Split Left 
 * In JAR Template MOD arcade drive split right, 
 * the left joystick controls turning, 
 * and the right joystick controls forward/backward movement.
 *
 **/
void Drive::control_arcade_splitRight()
{
...
/**
 * H-Drive with Strafe (Arcade Drive: Split Left)
 * Axis3 controls throttle
 * Axis1 controls turning
 * Axis4 controls strafing
 *
 **/
...
/**
 * Tank Drive
 * Axis3 controls left motor group throttle
 * Axis2 controls right motor group throttle
 * Turning is zero-turn aspected
 *
 **/
